...
train_x = torch.from_numpy(np.load('train-x.npy')).to(device)
train_y = torch.from_numpy(np.load('train-y0.npy')).to(device)
test_x = torch.from_numpy(np.load('test-x.npy')).to(device)
test_y = torch.from_numpy(np.load('test-y.npy')).to(device)
